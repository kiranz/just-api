...
describe('before test hook', function () {
    ...
    before(async function () {
        let result = runJustAPIJSON('hooks/beforetest.suite.yml');
    ...
    it('before test hook inline sync funtion', function () {
    ...
    it('before test hook inline async funtion', function () {
        let result = suiteContext.result;
        let test = result.tests.find(t =>  t.name === this.test.title);
        expect(test.status).to.equal('pass');
        expect(test.error).to.be.a('null');
    ...
    it('before test hook module sync funtion', function () {
        let result = suiteContext.result;
        let test = result.tests.find(t =>  t.name === this.test.title);
        expect(test.status).to.equal('pass');
        expect(test.error).to.be.a('null');
    ...
    it('before test hook module async funtion', function () {
        let result = suiteContext.result;
        let test = result.tests.find(t =>  t.name === this.test.title);
        expect(test.status).to.equal('pass');
        expect(test.error).to.be.a('null');
    ...
    it('before test hook inline sync funtion throws error - should fail', function () {
        let result = suiteContext.result;
        let test = result.tests.find(t =>  t.name === this.test.title);
    ...
    it('before test hook inline async funtion throws error - should fail', function () {
        let result = suiteContext.result;
        let test = result.tests.find(t =>  t.name === this.test.title);
        expect(test.status).to.equal('fail');
        expect(test.error.name).to.equal('BeforeTestHookError');
    ...
    it('before test hook module sync funtion throws error - should fail', function () {
        let result = suiteContext.result;
        let test = result.tests.find(t =>  t.name === this.test.title);
        expect(test.status).to.equal('fail');
        expect(test.error.name).to.equal('BeforeTestHookError');
    ...
    it('before test hook module async funtion throws error - should fail', function () {
        let result = suiteContext.result;
        let test = result.tests.find(t =>  t.name === this.test.title);
        expect(test.status).to.equal('fail');
        expect(test.error.name).to.equal('BeforeTestHookError');
    ...
    it('before test hook module async funtion rejected promise - should fail', function () {
        let result = suiteContext.result;
        let test = result.tests.find(t =>  t.name === this.test.title);
        expect(test.status).to.equal('fail');
        expect(test.error.name).to.equal('BeforeTestHookError');
