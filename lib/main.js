...
program
    ...
    .usage('<options> <files>')
    .option('--parallel <integer>', 'specify the number of suite to be run in parallel')
    .option('--reporter <name>', 'specify the reporter to use')
...
if (!args.length) {
    console.warn('Suite file path/pattern/directory is not specified, Looking for suite files in specs directory');
